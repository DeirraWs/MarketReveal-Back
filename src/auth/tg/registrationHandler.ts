...
@Injectable()
export class RegistrationHandler extends Handler {
    ...
    constructor(
        ...
        super();
        command.addHandler("registration",this)
    }

    async handlerLogic(context: MyContext): Promise<any> {
        await context.reply("Registration start")
        await this.dialogService.startDialog(context,"registration")
    }
